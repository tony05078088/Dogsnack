...
<div >
 <section class="login-block">
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" v-model="password" autocomplete="on" placeholder="password">
  </div>
...
<div class="copy-text">Created with <i class="fa fa-heart"></i> by Grafreez</div>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        <div class="banner-text">
            <h2>To Track Your Order</h2>
            <p>To track your order, please enter your order number and zip code below</p>
        </div>
    </div>
    </div>
    <div class="carousel-item">
