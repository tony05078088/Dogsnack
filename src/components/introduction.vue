<template>
  <div>
    <div class="about">
      ...
      <div>
        <img
          src="https://media.gettyimages.com/photos/border-collie-picture-id92744180?s=2048x2048"
        />
      </div>
    </div>
    <h6>有關邊境牧羊犬</h6>
    <div>
      ...
      <br />
      <div>
        主要協助農場放牧，故稱「牧羊犬」。邊境牧羊犬以精力旺盛且容易學習雜技運動而聞名，且被學界認為是最聰明的犬種。
      </div>
      <br />
      <br />
      <div class="description">
        <div class="text">
          <strong>邊牧的物種分布</strong>
          <p class="item">
            原產於蘇格蘭邊境，具強烈的牧羊本能，被當成牧羊犬已有多年的歷史。現主要分布在四個國家：英國、美國、澳大利亞和紐西蘭。屬於工作狂型的犬種，不適合都市生活。全世界的牧羊工作，幾乎一半以上都由它們來擔任。有此一說：如果沒有牛羊給它看管，它就會看牧小孩。而且它天生就會牧羊。
          </p>
        </div>
        <div class="text">
          <strong>邊牧的發展起源</strong>
          <p class="item">
            最早時期蘇格蘭被放牧的羊以及用來看管羊的犬都是在蘇格蘭群島上被發現的，那些犬都是來源於以前從愛爾蘭移居到蘇格蘭的教士，它們帶過去的犬，在這種崎嶇的地理環境內人們也就只有依靠犬來幫忙集合、驅趕以及看牧牲畜了。根據現代牧羊犬的起源，它們有著「眼神控制」這樣的能力，這種能力是通過在英格蘭和蘇格蘭的邊界地方的牧羊人發展並且訓練出來的，所以人們把這種犬就稱作「邊境牧羊犬」。
          </p>
        </div>
        <div class="text">
          <strong>邊牧的生活習性</strong>
          <p class="item">
            邊境牧羊犬是好動的工作犬，最適合養在鄉村。如果關著不給活動，此犬種很快就會變得憂鬱，開始搞破壞。此犬種智商高、學習力強、對讚美的迴響良好。牠們具備牧羊的天性，所以懷有保護家庭和地域的警戒心，也是優秀的看門犬，會照顧家裡的小孩。雖然牠們和孩童以及其他從小一起養大的寵物相處融洽，有時對陌生人很兇，像牧羊時那樣窮追不捨、緊咬不放。
          </p>
        </div>
        <div class="text">
          <strong>邊牧的優點</strong>
          <p class="item">
            邊境牧羊犬有犬類熊貓之稱，是因為它黑白花色的分布和熊貓相似，尤其是60天以下的幼犬，圓滾滾的體型、蹣跚的步態，更像是一隻小熊貓。當然邊牧也有其他顏色和白色的搭配，諸如紅白、藍白
            、黃白、隕石色等等，但通常黑白的搭配被認為是最基礎和最標準的。
          </p>
        </div>
        <div class="text"></div>
        <div class="text">
          <strong>邊牧的缺點</strong>
          <p class="item">
            邊牧在自己的地盤上能夠憑藉聰明才智作威作福，但幾乎50%以上的邊牧甚至有被驚嚇後小便失禁的經歷。即使體形較大的成年邊牧，在陌生的地方面對陌生人的撫摩，也會抿著耳朵甚至翻著肚皮表現出完全地臣服。
          </p>
        </div>
        <div class="text" v-for="url in movieUrl" :key="url">
          <iframe
            class="movieshow"
...
export default {
  data() {
    return {
      movieUrl: ["zxs9yXDGNMI", "hxMsVbFr1Bc", "HtlhLfq-csg"]
    };
  }
};
</script>
